...
class TestConfigManager:
    ...
    def test_load_valid_config(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            config_data = {
                "training": {"epochs": 10, "batch_size": 64, "learning_rate": 0.01},
    ...
    def test_deep_merge(self):
        ...
        default_config = {
            ...
            "plugins": {"console_out": {"enabled": True, "config": {}}},
        }

        override_config = {
            "training": {"epochs": 10, "batch_size": 64},
            "plugins": {"tensorboard": {"enabled": True, "config": {"log_dir": "custom_dir"}}},
        }
...
class TestLoadConfig:
    ...
    def test_load_config_with_path(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            config_data = {"lr": 0.01, "batch_size": 64, "custom_param": "value"}
            json.dump(config_data, f)
            config_path = f.name
